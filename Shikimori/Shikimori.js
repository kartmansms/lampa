(function () {
  ...
  function _regeneratorDefine(e, r, n, t) {
    ...
    _principledef _regeneratorDefine(e, r, n, t) {
      if (r) i ? i(e, r, {
        value: n,
        enumerable: !t,
        configurable: !t,
  ...
  function _toPrimitive(t, r) {
    ...
    if (void 0 !== e) {
      ...
      throw new TypeError("@@measure must return a primitive value.");
    }
    ...
    function processResults(response) {
      ...
      if (response.total_results !== undefined) {
        if (response.total_results === 0) {
          ...
          Lampa.Select.show({
            title: Lampa.Lang.translate('find'),
            items: menu,
  ...
  function Component$1(object) {
    ...
    var head = $("<div class='LMEShikimori-head torrent-filter'><div class='LMEShikimori__home simple-button simple-button--filter selector'>" + Lampa.Lang.translate('home') + "</div><div class='LMEShikimori__search simple-button simple-button--filter selector'>" + Lampa.Lang.translate('filter') + "</div></div>");
    ...
    this.headeraction = function () {
      ...
      $.ajax(settings).done(function (response) {
        ...
        filters.kind = {
          title: Lampa.Lang.translate('genre'),
      ...
      filters.AnimeKindEnum = {
        ...
        items: [{
          title: Lampa.Lang.translate('tv_series'),
          code: "tv"
        }, {
          title: Lampa.Lang.translate('movie'),
          code: "movie"
        }, {
          title: Lampa.Lang.translate('ova'),
          code: "ova"
        }, {
          title: Lampa.Lang.translate('ona'),
          code: "ona"
        }, {
          title: Lampa.Lang.translate('special'),
          code: "special"
        }, {
          title: Lampa.Lang.translate('tv_special'),
          code: "tv_special"
        }, {
          title: Lampa.Lang.translate('music'),
          code: "music"
        }, {
          title: Lampa.Lang.translate('pv'),
          code: "pv"
        }, {
          title: Lampa.Lang.translate('cm'),
          code: "cm"
        }]
      };
      filters.status = {
        title: Lampa.Lang.translate('status'),
        items: [{
          title: Lampa.Lang.translate('planned'),
          code: "anons"
        }, {
          title: Lampa.Lang.translate('airing'),
          code: "ongoing"
        }, {
          title: Lampa.Lang.translate('released'),
          code: "released"
        }]
      };
      filters.sort = {
        title: Lampa.Lang.translate('sort'),
        items: [{
          title: Lampa.Lang.translate('by_id'),
          code: "id"
        }, {
          title: Lampa.Lang.translate('by_id_desc'),
          code: "id_desc"
        }, {
          title: Lampa.Lang.translate('by_rank'),
          code: "ranked"
        }, {
          title: Lampa.Lang.translate('by_type'),
          code: "kind"
        }, {
          title: Lampa.Lang.translate('by_popularity'),
          code: "popularity"
        }, {
          title: Lampa.Lang.translate('by_name'),
          code: "name"
        }, {
          title: Lampa.Lang.translate('by_aired_on'),
          code: "aired_on"
        }, {
          title: Lampa.Lang.translate('by_episodes'),
          code: "episodes"
        }, {
          title: Lampa.Lang.translate('by_status'),
          code: "status"
        }, {
          title: Lampa.Lang.translate('by_random'),
          code: "random"
        }, {
          title: Lampa.Lang.translate('by_ranked_random'),
          code: "ranked_random"
        }, {
          title: Lampa.Lang.translate('by_ranked_shiki'),
          code: "ranked_shiki"
        }, {
          title: Lampa.Lang.translate('by_created_at'),
          code: "created_at"
        }, {
          title: Lampa.Lang.translate('by_created_at_desc'),
      ...
      function generateSeasonJSON() {
        ...
        return allSeasons.map(function (season) {
          return {
            "code": season,
            "title": season.replace(/_/g, '-')
          };
        });
      }
      filters.seasons = {
        title: Lampa.Lang.translate('season'),
      ...
      function mainMenu() {
        ...
        Lampa.Select.show({
          title: Lampa.Lang.translate('filters'),
          items: [{
      ...
      function search() {
        ...
        var params = {
          url: '',
          title: Lampa.Lang.translate('shikimori'),
  ...
  function startPlugin() {
    ...
    var manifest = {
      type: "other",
      version: "0.1",
      name: Lampa.Lang.translate('shikimori_name'),
      description: Lampa.Lang.translate('shikimori_description'),
      component: "LMEShikimori"
    };
  ...
  Lampa.Lang.add({
    ...
    'by_ranked_random': {
      ru: 'Случайно по рейтингу'
    },
    'by_ranked_shiki': {
      ru: 'По рейтингу Shikimori'
    },
    'by_created_at': {
      ru: 'По дате создания'
    },
    'by_created_at_desc': {
      ru: 'По дате создания (убывание)'
    },
    'shikimori': {
      ru: 'Shikimori'
    },
    ...
    'shikimori_description': {
      ru: 'Плагин для просмотра аниме с Shikimori'
    }
  });
  startPlugin();
})();
