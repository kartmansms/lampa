(function () {
  ...
  // Определение переводов для русского языка
  const translations = {
    ru: {
      'Home': 'Главная',
      'Filter': 'Фильтр',
      ...
      'By release date': 'По дате выпуска',
      'By number of episodes': 'По количеству эпизодов',
      'By status': 'По статусу',
      'By random': 'Случайно',
      'By Shikimori ranking': 'По рейтингу Шикимори',
      'created_at': 'По дате создания',
      'created_at_desc': 'По дате создания (убывание)',
      'TV Series': 'ТВ Сериал',
      'Movie': 'Фильм',
      'OVA': 'OVA',
      'ONA': 'ONA',
      ...
      'Airing': 'Онгоинг',
      'Released': 'Вышло',
      'Fan Dubbers': 'Фан-дабберы',
      'Fan Subbers': 'Фан-сабберы',
      'LME Shikimori': 'LME Шикимори',
      'Add Shikimori catalogue': 'Добавить каталог Шикимори'
    }
  };
  ...
  function Component$1(object) {
    ...
    var head = $("<div class='LMEShikimori-head torrent-filter'><div class='LMEShikimori__home simple-button simple-button--filter selector'>".concat(t('Home'), "</div><div class='LMEShikimori__search simple-button simple-button--filter selector'>").concat(t('Filter'), "</div></div>"));
    ...
    this.headeraction = function () {
      ...
      filters.sort = {
        ...
        items: [{
          ...
          title: t("By popularity"),
          code: "popularity"
        }, {
          title: t("In alphabetical order"),
          code: "name"
        }, {
          title: t("By release date"),
          code: "aired_on"
        }, {
          title: t("By number of episodes"),
          code: "episodes"
        }, {
          title: t("By status"),
          code: "status"
          ...
          title: t("By Shikimori ranking"),
          code: "ranked_shiki"
        }, {
          title: t("created_at"),
          code: "created_at"
        }, {
          title: t("created_at_desc"),
    ...
    this.body = function (data) {
      data.forEach(function (anime) {
        ...
        }).on("hover:enter", _asyncToGenerator(_regenerator().m(function _callee() {
  ...
  function Component() {
    Lampa.Listener.follow("full", _asyncToGenerator(_regenerator().m(function _callee(e) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 4:
            response = _context.v;
            dubbers = "\n                    <div class=\"full-descr__info\">\n                        <div class=\"full-descr__info-name\">".concat(t('Fan Dubbers'), "</div>\n                        <div class=\"full-descr__text\">").concat(response.fandubbers.join(', '), "</div>\n                    </div>");
            subbers = "\n                    <div class=\"full-descr__info\">\n                        <div class=\"full-descr__info-name\">".concat(t('Fan Subbers'), "</div>\n                        <div class=\"full-descr__text\">").concat(response.fansubbers.join(', '), "</div>\n                    </div>");
            e.object.activity.render().find(".full-descr__right").append(dubbers, subbers);
            shikimoriRates = "<div class=\"full-start__rate rate--shikimori\"><div>".concat(response.score, "</div><div>").concat(t('Shikimori'), "</div></div>");
  ...
  function startPlugin() {
    ...
    var manifest = {
      type: "other",
      version: "0.1",
      name: t("LME Shikimori"),
      description: t("Add Shikimori catalogue"),
      component: "LMEShikimori"
    };
